      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center space-y-8">
        ...
        <div className="flex justify-center gap-6 flex-wrap">
          ...
          <a
            href="/Jony_CV.pdf"
            download
            className="border border-primary px-6 py-3 rounded-full font-semibold text-primary hover:bg-gray-700 hover:text-white hover:scale-105 transition-all duration-300 animate-slideIn opacity-0"
          >
            Download CV
          </a>
        </div>
